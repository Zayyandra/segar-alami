<x-layouts.admin title="Tambah User">
    <div class="max-w-2xl mx-auto space-y-5">
        ...
        <div>
            ...
            <h1 class="mt-2 text-2xl font-semibold text-slate-900">Tambah User</h1>
            <p class="mt-1 text-sm text-slate-500">Buat akun pengguna baru untuk sistem Segar Alami.</p>
        </div>
            ...
            <form method="POST" action="{{ route('app.users.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}"
                           placeholder="contoh@segaralami.com"
                           class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm
                                  focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none
