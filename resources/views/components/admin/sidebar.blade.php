    ...
    if ($isAdmin) {
        ...
        $groups = [
            ...
            [
                'label' => 'Manajemen',
                'items' => [
                    ['route' => 'app.users.index',          'label' => 'User Management',    'icon' => 'users'],
                ],
            ],
        ];
    }
...
<aside class="w-64 flex flex-col shrink-0 min-h-screen" style="background-color: #1a2035;">
                ...
                <div class="space-y-0.5">
                    @foreach ($group['items'] as $item)
                        @php
                            ...
                            $pattern = $item['route'] === 'app.dashboard'
                                ? 'app.dashboard'
                                : rtrim(preg_replace('/\.(index|penjualan|persediaan)$/', '', $item['route']), '.') . '.*';
    ...
    <div class="p-3" style="border-top: 1px solid rgba(255,255,255,0.07);">
        <div class="flex items-center gap-3 px-3 py-2.5 mb-1 rounded-xl"
