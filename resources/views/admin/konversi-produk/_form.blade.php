    ...
    <div>
        ...
        <select name="varian_produk_id"
            ...
            @foreach ($varianProduks as $varian)
                <option value="{{ $varian->id }}" @selected(old('varian_produk_id', $konversiProduk->varian_produk_id) == $varian->id)>
                    {{ $varian->produk->nama }} —
    ...
    <div>
        ...
        <select name="bahan_baku_id" x-model="selectedBB"
            ...
            @foreach ($bahanBakus as $bb)
                <option value="{{ $bb->id }}" @selected(old('bahan_baku_id', $konversiProduk->bahan_baku_id) == $bb->id)>
                    {{ $bb->nama }} ({{ $bb->satuan }})
                </option>
            @endforeach
        </select>
